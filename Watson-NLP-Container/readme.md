# Serve Stock Watson NLP Models from a Standalone Container
In this tutorial you will learn how to serve stock Watson NLP models from a standalone container.  Both the ML models and the model runtime will be packaged into the container image.  When the container runs it will expose REST and gRPC endpoints that client programs can use to do inference on the models. 
