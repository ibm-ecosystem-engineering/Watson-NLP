...
navbar_main = dbc.Navbar(
    [
        ...
        dbc.Row(html.H2("Watson NLP"), className="me-auto", justify="center"),
        dbc.Row(
            [
                dbc.Nav(
                    [
...
tone_button = html.Div(
    [
        dbc.Button("Get Tone", id="tone-button", className="me-2", n_clicks=0),
    ]
)
...
def update_output(n_clicks, value):
    ...
    fig_tone.update_layout(
        template=plotly_template, barmode="stack", title_text="Tone Score", title_x=0.5
    )
