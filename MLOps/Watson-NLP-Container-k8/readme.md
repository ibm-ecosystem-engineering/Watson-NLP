...
***If you reserved a sandbox in [TechZone](https://github.com/ibm-build-lab/Watson-NLP/tree/sandbox-reserve-ht/MLOps/reserve-openshift-sandbox#readme), you will find `<REGISTRY>` and `<NAMESPACE>` in the confirmation email you received when the sandbox was ready.***
