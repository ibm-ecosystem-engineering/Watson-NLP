...
- Ensure that Docker can access the [Watson NLP Runtime and pretrained model images](https://github.com/ibm-build-labs/Watson-NLP/blob/main/access/README.md#docker).
